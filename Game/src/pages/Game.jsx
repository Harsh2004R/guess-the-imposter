...
import { playNotification } from "../utils/audioManager.js"
...
function Game() {
  ...
  useEffect(() => {
    if (!room?.pickedPlayerId) return;

    if (
      previousPickedPlayerRef.current ===
      room.pickedPlayerId
    ) {
      return;
    }
